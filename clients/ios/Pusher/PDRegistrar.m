...
{
    PDSettings * settings = [[PDSettings alloc] init];
    NSMutableDictionary * registration = [[NSMutableDictionary alloc] initWithCapacity:2];

    [registration setValue:settings.listeningIPAddress forKey:@"host"];
    [registration setValue:@(settings.listeningPort) forKey:@"port"];
    
    NSURLRequest * request = [self prepareRequest:host body:[NSDictionary dictionaryWithObject:registration forKey:@"recipient"]];
